...
// ethEnabled();
  ...
  initContract: function() {
    ...
    $.getJSON("Contest.json",function(contest){
      ...
      App.contracts.Contest.setProvider(new Web3.providers.HttpProvider('http://localhost:7545'));
  ...
  render: function(){
    ...
    App.contracts.Contest.web3.eth.getCoinbase(function(err,account){
      if(err===null){
        App.account = account;
  ...
  registerVoter: function(){
    ...
    App.contracts.Contest.deployed().then(function (instance) {
      var p=instance.voterRegisteration(add)
      console.log(p)
      return p;
    }).then(function(result){
      $("#content").hide();
